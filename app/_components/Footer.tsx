        ...
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          ...
          <div className="grid grid-cols-2 gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div className="py-2">
              ...
              <ul className="mt-1">
                <li>Emma Hagelin</li>
                <li className="mb-5">Edsgatevägen 165, Karlstad</li>

                <li>Org.nr 5594388828</li>
              </ul>
            </div>
            ...
            <div className="py-2">
              <h3 className="uppercase dark-text">Villkor</h3>
              <ul className="mt-1">
                <li>
                  <Link
            ...
            <div className="py-2">
              <div className="uppercase dark-text">Sociala medier</div>
              <div className="mt-1 flex justify-start space-x-3">
                <a
                  rel="noopener noreferrer"
                  href="https://www.facebook.com/bjorbyblomster"
                  title="Facebook"
                  className="p-1"
                  target="_blank"
                >
